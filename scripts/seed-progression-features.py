...
FEATURES = [
    ...
    ("Aumento de STAB", "aumento-de-stab",
     ...
     "<p><em>Atualize o bônus fixo nas fórmulas de dano dos Moves do mesmo tipo do Pokémon "
     "(o valor atual é aplicado automaticamente só no nível em que a ficha foi importada).</em></p>"),
